...
3. 메인 에이전트: **결과를 `<project-root>/docs/prd/[feature]/review-claude-plan-r{N}.md`로 저장** (N=회차, 덮어쓰기 금지) 후 판정
   - **하네스 메타 변경(간소 PRD)일 경우**: 파일명은 `review-claude-meta-r{N}.md` 단일 리뷰로 대체 (plan/eng/code 구분 없이 meta 하나). Codex 저장도 `review-codex-meta.md`
...
6. **Claude 통과 후 Codex 추가 리뷰 (1회)**:
   ...
   - stdout을 `<project-root>/docs/prd/[feature]/review-codex-plan.md`에 저장 (하네스 메타 변경일 경우 `review-codex-meta.md`)
