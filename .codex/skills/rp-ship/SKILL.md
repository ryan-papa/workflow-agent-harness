---
name: rp-ship
description: "[11] 커밋·PR·CI·머지·배포. 수동 git/gh 우회 금지, 반드시 이 스킬 경유. Use when Codex should run or follow the harness rp-ship stage, or when the user invokes /rp-ship, $rp-ship, or asks for this workflow step."
---
